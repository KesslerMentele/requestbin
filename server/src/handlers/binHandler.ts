...
import {BinHandler, PostgresService} from "../types";
const createBinHandler = (pgService:PostgresService):BinHandler => {

  const createBin: RequestHandler = async (req: Request, res: Response) => {
    try {
  ...
  const deleteBin: RequestHandler = async (req: Request, res: Response) => {
    try {
  ...
  const getAllBins: RequestHandler = async (_req: Request, res: Response) => {
    try {
  ...
  const deleteAllRequestsFromBin: RequestHandler = async (req: Request, res: Response) => {
    try {
      const binName = req.params.binName as string;
      const pgRequests = await pgService.getAllRequests(binName);
      const mongoIDs = pgRequests.map((request) => request.mongodb_id);
  ...
  const getAllRequestsForBin: RequestHandler = async (req: Request, res: Response) => {
    try {
      const binName = req.params.binName as string;
  ...
  const deleteRequest: RequestHandler = async (req: Request, res: Response) => {
    try {
      const binName = req.params.binName as string;
...
export default createBinHandler;